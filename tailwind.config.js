    ...
    extend: {
      ...
      keyframes: (theme) => ({
        ...
        borderAnimation: {
          ...
          '45%': { borderColor: `${theme.colors.indigo[500]} transparent transparent transparent` },
          '50%': { borderColor: `${theme.colors.indigo[500]} ${theme.colors.indigo[500]} transparent transparent` },
          '95%': { borderColor: `${theme.colors.indigo[500]} ${theme.colors.indigo[500]} ${theme.colors.indigo[500]} transparent` },
      ...
      animation: {
        ...
        'border-animation': 'borderAnimation 0.4s linear forwards',
      },
    },
  },
